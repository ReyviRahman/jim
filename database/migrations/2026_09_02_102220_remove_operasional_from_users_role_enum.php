...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE users MODIFY COLUMN role ENUM('admin','pt','member','kasir_gym','sales','kasir_minum','head_coach','cleaning_service') NOT NULL DEFAULT 'member'");
    }
