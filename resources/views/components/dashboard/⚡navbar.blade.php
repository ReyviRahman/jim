    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                <button data-sidebar-toggle="top-bar-sidebar" aria-controls="top-bar-sidebar" aria-expanded="false" type="button" class="text-brand bg-transparent box-border border border-transparent hover:bg-neutral-secondary-medium focus:ring-4 focus:ring-neutral-tertiary font-medium leading-5 rounded-md text-sm p-2 focus:outline-none">
                    <span class="sr-only" data-sidebar-toggle-label>Buka sidebar</span>
                                ...
                                @if(Auth::user()->role === 'admin')
                                    <li>
                                        <a href="{{ route('admin.whatsapp.settings') }}" wire:navigate
                                            class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Pengaturan WhatsApp</a>
                                    </li>
                                @endif
                                <li>
                                    <button type="button" 
