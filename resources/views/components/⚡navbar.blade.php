    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
                ...
                <li>
                    <a href="/" 
                        class="block py-2 px-3 rounded md:p-0 {{ request()->is('/') ? 'bg-brand text-white md:bg-transparent md:text-fg-brand' : 'text-heading hover:bg-neutral-tertiary md:hover:bg-transparent' }}" wire:navigate>
                        Beranda
                    </a>
                </li>
                <li>
                    <a href="/pendaftaran/member" 
