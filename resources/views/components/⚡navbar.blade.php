...
<nav class="bg-[#34342F] fixed w-full z-20 top-0 start-0  ">
            ...
            @auth
                ...
                <div class="z-50 hidden bg-[#34342F] border border-default-medium rounded-base shadow-lg w-44" id="user-dropdown">
                    ...
                    <ul class="p-2 text-sm text-white font-medium" aria-labelledby="user-menu-button">
                        <li>
                            <a href="{{ Auth::user()->isHeadCoach() ? route('admin.cicilan.index') : match(Auth::user()->role) { 'admin' => route('admin.absensi.index'), 'pt' => route('pt.absensi'), default => route('member.dashboard') } }}"
    class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Dashboard</a>
            ...
            <button data-collapse-toggle="navbar-user" type="button"
                class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-brand rounded-base md:hidden hover:bg-neutral-secondary-soft hover:text-heading focus:outline-none focus:ring-2 focus:ring-neutral-tertiary"
