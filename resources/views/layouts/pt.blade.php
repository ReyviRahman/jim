    ...
    <body>
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default">
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ route('pt.absensi') }}" wire:navigate class="{{ request()->routeIs('pt.absensi') ? 'text-fg-brand bg-neutral-tertiary' : 'text-body' }} flex items-center px-2 py-1.5 rounded-md hover:bg-neutral-tertiary hover:text-fg-brand group">
                ...
                <li>
                    <a href="{{ route('pt.kehadiran.index') }}" wire:navigate class="{{ request()->routeIs('pt.kehadiran.*') ? 'text-fg-brand bg-neutral-tertiary' : 'text-body' }} flex items-center px-2 py-1.5 rounded-md hover:bg-neutral-tertiary hover:text-fg-brand group">
