    ...
    <body>
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-primary-soft border-e border-default">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ route('member.kehadiran.index') }}" wire:navigate class="{{ request()->routeIs('member.kehadiran.*') ? 'text-fg-brand bg-neutral-tertiary' : 'text-body' }} flex items-center px-2 py-1.5 rounded-md hover:bg-neutral-tertiary hover:text-fg-brand group">
                ...
                <li>
                    <a href="{{ route('member.membership.index') }}" wire:navigate class="{{ request()->routeIs('member.membership.*') ? 'text-fg-brand bg-neutral-tertiary' : 'text-body' }} flex items-center px-2 py-1.5 rounded-md hover:bg-neutral-tertiary hover:text-fg-brand group">
