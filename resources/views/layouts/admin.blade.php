...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body @class(['coach-directory-layout' => request()->routeIs('admin.sesi-pt.index'), 'pt-installments-layout' => request()->routeIs('admin.pt-cicilan.index', 'admin.cicilan.index')])>
