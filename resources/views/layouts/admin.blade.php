        ...
        <div class="flex h-full flex-col py-4 overflow-y-auto bg-[#34342F] border-e border-default [&>*]:shrink-0">
            ...
            @if ($isAdmin)
                ...
                <ul class="space-y-2 font-medium px-3">
                    ...
                    <li>
                        <a href="{{ route('admin.rentang-bonus.index') }}" wire:navigate
                            class="{{ request()->routeIs('admin.rentang-bonus.*') ? 'text-[#34342F] bg-brand' : 'text-white' }} flex items-center px-2 py-1.5 rounded-md hover:bg-brand hover:text-[#34342F] group transition-colors">
                            ...
                            <span class="ms-3">Rentang Bonus</span>
                        </a>
                    </li>
                </ul>
            @endif
            ...
            @if($isAdmin || $isKasir || $isKasirMinum)
                <div class="bg-white px-4 py-1 my-2">
                    <h1 class="font-bold">TRANSAKSI MINUMAN</h1>
                </div>
                <ul class="space-y-2 font-medium px-3">
                    <li>
                        <a href="{{ route('admin.beverages.index') }}" wire:navigate
                            class="{{ request()->routeIs('admin.beverages.index') || request()->routeIs('admin.beverages.restock') ? 'text-[#34342F] bg-brand' : 'text-white' }} flex items-center px-2 py-1.5 rounded-md hover:bg-brand hover:text-[#34342F] group transition-colors">
                    ...
                    <li>
                        <a href="{{ route('admin.beverages.pos') }}" wire:navigate
                            class="{{ request()->routeIs('admin.beverages.pos') || request()->routeIs('admin.beverages.hutang') || request()->routeIs('admin.beverages.deposit') ? 'text-[#34342F] bg-brand' : 'text-white' }} flex items-center px-2 py-1.5 rounded-md hover:bg-brand hover:text-[#34342F] group transition-colors">
            ...
            <div class="bg-white px-4 py-1 my-2">
                <h1 class="font-bold">MEMBERSHIP</h1>
            </div>
            @endif
            <ul class="space-y-2 font-medium px-3">
                ...
                <li>
                    <a href="{{ route('admin.membership.gabung') }}" wire:navigate 
                        ...
                        <span class="ms-3">Member Belum Aktif</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.membership.non-member') }}" wire:navigate 
                        class="{{ request()->routeIs('admin.membership.non-member') ? 'text-[#34342F] bg-brand' : 'text-white' }} flex items-center px-2 py-1.5 rounded-md hover:bg-brand hover:text-[#34342F] group transition-colors">
            ...
            @if($isAdmin || $isKasir || $isHeadCoach)
            <div class="bg-white px-4 py-1 my-2">
                <h1 class="font-bold">PERSONAL TRAINING</h1>
            </div>
            <ul class="space-y-2 font-medium px-3">
                {{-- <li>
                ...
                <li>
                    <a href="{{ route('admin.pt-expired.index') }}" wire:navigate
