            ...
            <div class="p-6 sm:p-10">
                ...
                <div class="py-8">
                    ...
                    <p class="mt-3 text-sm leading-6 text-white/65">
                        Tanda tangan digital pada URL valid dan data di bawah ini cocok dengan catatan FRANS GYM.
                    </p>
                </div>

                <dl class="grid gap-px overflow-hidden rounded-xl border border-white/10 bg-white/10 sm:grid-cols-2">
                    <div class="bg-[#171717] p-5">
                        <dt class="text-xs font-medium uppercase tracking-wider text-white/45">Nama Member</dt>
                        <dd class="mt-2 font-semibold">{{ $membership->user?->name ?? '-' }}</dd>
                    </div>
                    <div class="bg-[#171717] p-5">
                        <dt class="text-xs font-medium uppercase tracking-wider text-white/45">ID Member</dt>
                        <dd class="mt-2 font-semibold">{{ $memberNumber }}</dd>
                    </div>
                    <div class="bg-[#171717] p-5">
                        <dt class="text-xs font-medium uppercase tracking-wider text-white/45">Paket</dt>
                        <dd class="mt-2 font-semibold">{{ $packageName }}</dd>
                    </div>
                    <div class="bg-[#171717] p-5">
                    ...
                    <div class="bg-[#171717] p-5">
                        ...
                        <dd class="mt-2 font-semibold">{{ $membershipEndDate }}</dd>
                    </div>
                    <div class="bg-[#171717] p-5">
                        <dt class="text-xs font-medium uppercase tracking-wider text-white/45">Status Pembayaran</dt>
