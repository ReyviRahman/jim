    ...
    <form wire:submit.prevent="update">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div x-data="{ show: false, currentRole: @entangle('role') }">
                <label for="password" class="block mb-2.5 text-sm font-medium text-heading" x-show="currentRole !== 'sales'">Password (Opsional)</label>
                ...
                <div class="relative">
                    <input :type="show ? 'text' : 'password'" id="password" wire:model="password"
                        ...
                        placeholder="Kosongkan jika tidak diubah" x-show="currentRole !== 'sales'" />

                    <button type="button" @click="show = !show"
                        class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-brand focus:outline-none" x-show="currentRole !== 'sales'">
