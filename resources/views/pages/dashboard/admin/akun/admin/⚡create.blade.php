...
new #[Layout('layouts::admin')] class extends Component
{
    ...
    #[Validate('required_unless:role,sales|min:6')]
    public $password = '';

    #[Validate('required|in:kasir_gym,kasir_minum,pt,sales')]
    ...
    public function store()
    {
        ...
        if ($this->role === 'pt') {
            $userData['occupation'] = 'Personal Trainer';
    ...
    <form wire:submit="store">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div x-data="{ show: false, currentRole: @entangle('role') }" class="mb-4 sm:col-span-2">
                <label for="password" class="block mb-2.5 text-sm font-medium text-heading" x-show="currentRole !== 'sales'">Password</label>
                ...
                <div class="relative">
                    <input :type="show ? 'text' : 'password'" id="password" wire:model="password"
                        ...
                        placeholder="•••••••••" required x-show="currentRole !== 'sales'" />
