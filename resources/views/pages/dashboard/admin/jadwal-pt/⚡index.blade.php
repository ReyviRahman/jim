...
use Livewire\WithPagination;
    ...
    {
        return (new PtScheduleExport($this->search, $this->filterPt))
    ...
    <div class="relative overflow-x-auto bg-neutral-primary-soft shadow-xs rounded-md border border-default">
        <div class="p-4 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                ...
                <button wire:click="export" class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-emerald-600 rounded hover:bg-emerald-700 transition-colors">
