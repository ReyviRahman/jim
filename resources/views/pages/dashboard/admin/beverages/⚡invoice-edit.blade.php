                            ...
                            <tr class="border-b border-default hover:bg-neutral-secondary-medium">
                                ...
                                <td class="px-4 py-2">
                                    <div x-data="{
                                        ...
                                        formatted: '{{ isset($items[$index]['harga_perdus']) ? number_format((int)$items[$index]['harga_perdus'], 0, ',', '.') : '' }}',
                                        init() {
                                            this.$watch('value', v => {
                                ...
                                <td class="px-4 py-2">
                                    <div x-data="{
                                        ...
                                        formatted: '{{ isset($items[$index]['biaya_ppn']) ? number_format((int)$items[$index]['biaya_ppn'], 0, ',', '.') : '' }}',
                                        init() {
                                            this.$watch('value', v => {
                                                let num = parseInt(v) || 0;
                                                this.formatted = num.toLocaleString('id-ID');
