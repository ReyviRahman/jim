...
new #[Layout('layouts::admin')] class extends Component
{
    ...
    public function mount(Beverage $beverage)
    {
        $this->beverage = $beverage;
        $this->nama_produk = $beverage->nama_produk;
        $this->harga_modal = $beverage->harga_modal;
        $this->harga_jual = $beverage->harga_jual;
    }
...
<div>
    <h1 class="text-3xl text-center font-semibold mb-6">Edit Minuman</h1>
    ...
    <form wire:submit.prevent="update" class="max-w-xl mx-auto">
        <div class="mb-4">
