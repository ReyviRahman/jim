...
new #[Layout('layouts::pt')] class extends Component
{
    ...
    {
        $query = Membership::with(['user', 'members', 'ptPackage', 'ptSchedule.days'])
            ->where('pt_id', Auth::id())
...
<div class="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Daftar jadwal latihan personal training yang ditugaskan kepada Anda.</p>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-600">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 font-semibold">Sisa Sesi</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse ($memberships as $membership)
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-gray-700">
                                <span class="inline-flex items-center justify-center h-8 w-8 rounded-full {{ $membership->remaining_sessions <= 2 ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800' }} text-sm font-bold">
                    ...
                    @empty
                        <tr>
                            <td colspan="10" class="px-6 py-10 text-center">
                                ...
                                @else
                                    <p class="text-xs text-gray-400 mt-1">Jadwal akan muncul setelah admin menugaskan membership kepada Anda.</p>
                                @endif
                            </td>
                        </tr>
                    @endforelse
