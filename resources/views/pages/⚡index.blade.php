                ...
                @auth
                    ...
                    <div class="z-50 hidden bg-[#34342F] border border-default-medium rounded-base shadow-lg w-44" id="user-dropdown">
                        ...
                        <ul class="p-2 text-sm text-white font-medium" aria-labelledby="user-menu-button">
                            <li>
                                <a href="{{ match(Auth::user()->role) { 'admin' => route('admin.absensi.index'), 'head_coach' => route('admin.cicilan.index'), 'pt' => route('pt.absensi'), 'kasir_gym' => route('admin.absensi.index'), default => route('member.dashboard') } }}" class="inline-flex items-center w-full p-2 hover:bg-neutral-tertiary-medium hover:text-brand rounded transition-colors">Dashboard</a>
                            </li>
                            <li>
